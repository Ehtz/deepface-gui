...
db_path_label = tk.Label(root, text="Database Folder:")
db_path_label.pack()
...
img2_path_label = tk.Label(root, text="Second Image:")
...
open_second_image_button = tk.Button(root, text="Open Second Image", command=open_second_image)
